...
Public Class UnitsDisplay
    ...
    Private Sub UnitsDisplay_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            pf.ProjectFuction(ProjectName, "Units")
            UnitEnteredBy.Text = UserPass
            'SelDate.Format.Custom=DateTi
    ...
    Private Sub FillTree()
        Try
            ...
            Dim daProjects As New OleDbDataAdapter("Select * from Projects where projecttype='Units' order by [project name] asc", Con)
            Dim daUnits As New OleDbDataAdapter("Select * from UnitsTable ", Con)
            Dim daUnitsEmpty As New OleDbDataAdapter("Select * from UnitsTable where [Project ID]<1", Con)
            Dim dS As New DataSet
            Dim dr, dr2 As DataRow
            daProjects.Fill(dS, "Projects")
            daUnits.Fill(dS, "Unitstable")
            ...
            For Each dr In dS.Tables("Projects").Rows
                ...
                For Each dr2 In dS.Tables("UnitsTable").Rows
                    If dr("Project ID") = dr2("Project ID") Then
                        If dr2("Unit No").ToString.Length < 1 Then
                            str = "NA"
                        Else

                            str = dr2("Unit No").ToString
                        End If
    ...
    Private Sub TreeView1_AfterSelect(ByVal sender As System.Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles TreeView1.AfterSelect
        Try
            ...
            DatainView_Unit()
            'selectedNode = TreeView1.SelectedNode.Tag
            Call FileRet()
        Catch ex As Exception
            ' MessageBox.Show(ex.ToString)
        End Try
        ...
        Try
            ...
            Else
                ...
                & "[Project ID]         ='" & ProjID _
                 ...
                 & "', [Unit No]             ='" & UnitUnitNo.Text _
                 & "', [Unit Type]           ='" & UnitUnitType.Text _
                 & "', [No of Bedrooms]      ='" & UnitRooms.Text _
                 & "', [floor]               ='" & UnitFloor.Text _
                 & "', [view]                ='" & UnitView.Text _
                 & "', [Area]                ='" & UnitArea.Text _
                 & "', [Land Area]           ='" & UnitLandArea.Text _
                 & "', [SqrFt/SqrMt]         ='" & UnitSqrorMtr.Text _
    ...
    Private Sub Save_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save_Button.Click
        Try
            ...
            Else
                ...
                SQL = "select count([Property ID])  from [unitsTable]"
                objCmd = New OleDbCommand(SQL, Con)
                vl = objCmd.ExecuteScalar
                If vl > 0 Then
                    SQL = "select max([Property ID])  from [unitsTable]"
                    objCmd = New OleDbCommand(SQL, Con)
                ...
                SQL = "insert into UnitsTable ([Project ID],[Property ID], [User ID],[Master Project], [Community/project], [Property Type], [Block/Building] " _
                                      ...
                                      & UnitPropertyType.Text & "','" & UnitBlockBuilding.Text & "','" & UnitPhase.Text & "','" & UnitsAddress.Text & "','" & UnitCountry.Text & "','" & UnitCity.Text & "','" & _
                                       UnitUnitNo.Text & "','" & UnitUnitType.Text & "','" & UnitRooms.Text & "','" & UnitFloor.Text & "','" & UnitView.Text & "','" & UnitArea.Text & "','" & UnitLandArea.Text & "','" & _
                                       UnitSqrorMtr.Text & "','" & UnitBalcony.Text & "','" & UnitOriginalPrice.Text & "','" & UnitSellingPrice.Text & "','" & UnitCountryCurrency.Text & "','" & _
                                       UnitVacancyStatus.Text & "','" & UnitCompletionDate.Text & "','" & UnitEnteredBy.Text & "','" & AgentSeller.Text & "','" & UnitNameOfSource.Text & "','" & _
                                       UnitContactNo.Text & "','" & UnitEmailId.Text & "','" & Now.Date.ToShortDateString & "','" & Now.Date.ToShortDateString & "','" & UnitNotes1.Text & "','" & UnitNotes2.Text & "','" & img1 & "','" & _
                                       img2 & "','" & img3 & "','" & img4 & "','" & MapUrl & "')"
    ...
    Private Sub DeleteProperty_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteProperty.Click
        Try
            Dim cmd As New OleDbCommand("delete * from UnitsTable where [Property ID]=" & TreeView1.SelectedNode.Tag, Con)
            cmd.ExecuteNonQuery()
    ...
    End Sub
    Private Sub UnitMessage_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UnitMessage.Click
        MessageShow.TextBox1.Text = " (Compulsory Field) Enter the unit number provided by the Developer or the Authorities, Example: 205, this should indicate that apartment 205 is the 5th apartment on the 2nd floor of a building, or in other cases V21-02, this may apply when a villa is located in district or phase 2, and is built on lot 21"
    ...
    Private Sub FloorMessage_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FloorMessage.Click
        MessageShow.TextBox1.Text = " Enter the floor the unit is located on, Example G (or) Ground Floor, or 3 (for third floor)"
    ...
    Private Sub SizeMessage_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SizeMessage.Click
        MessageShow.TextBox1.Text = "indicate the size of your apartment, Example: 1,200 sqft, or 80 sqm"
    ...
    Private Sub Attach_File_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Attach_File.Click
        Try
    ...
    Public Sub FileRet()
        ...
        Dim cmdList As New OleDbCommand("Select * from filesTable where [property id]=" & TreeView1.SelectedNode.Tag & " and [File Source] = 'Units' ", Con)
    ...
    Private Sub DeleteAttached_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteAttached.Click
        Try
            If FileList.SelectedItem.ToString.Length >= 1 Then
                ...
                Dim cmdList As New OleDbCommand("delete from filesTable where [property id]=" & TreeView1.SelectedNode.Tag & " and [File Source] = 'Units' and [File Name]='" & FileList.SelectedItem.ToString & "'", Con)
